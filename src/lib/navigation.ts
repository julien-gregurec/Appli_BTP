...
export const NAVIGATION_APPLICATION: NavigationApplication[] = [
  ...
  { href: "/grands-deplacements", label: "Grands déplacements", actif: true, permission: ["saisir_ses_notes_frais", "gerer_notes_frais"], groupe: "equipe" },
  { href: "/paie", label: "Préparation de la paie", actif: true, permission: ["consulter_sa_paie", "saisir_variables_paie", "controler_variables_paie", "gerer_paie", "exporter_paie", "parametrer_paie"], groupe: "equipe" },
