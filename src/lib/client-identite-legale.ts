...
import { normalizeVatNumber, isValidVatNumber } from "@/lib/gp-v1-rc-legal-identifiers";
...
// comprise. GP_V1_RC : ce paquet est absent de la baseline release ; les fonctions pures
// utilisées ici sont vendues à l'identique dans `@/lib/gp-v1-rc-legal-identifiers` plutôt
// que réécrites — voir ce fichier pour la provenance. La base pose des contraintes de forme
