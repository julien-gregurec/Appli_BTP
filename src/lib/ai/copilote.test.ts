...
// sensibles (l'IA ne doit jamais donner plus que les droits réels de l'utilisateur).
...
describe("droits de menu appliqués aux outils sensibles du copilote IA", () => {
  ...
  it("heures_supplementaires_semaine (heures de toute l'équipe) requiert gerer_pointage, pas seulement saisir_son_pointage", () => {
