        ...
        <form action={creerNoteFraisAction} className="space-y-3 rounded-md border border-dashed border-neutral-300 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-900/50">
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
            <label className="text-xs text-neutral-500">Salarié
              <select name="employe_id" className={input + " mt-1 w-full"}>
                <option value="">—</option>
          ...
          <button type="submit" className="rounded-md bg-neutral-900 px-4 py-2 text-sm font-medium text-white dark:bg-white dark:text-neutral-900">Envoyer la note de frais</button>
        </form>
