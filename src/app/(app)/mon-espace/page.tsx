...
export default async function MonEspacePage({searchParams}:{searchParams:Promise<{error?:string;succes?:string}>}){
  ...
  if(!employe){
    if(isEmailLoginDisabled())return <main className="p-8"><div className="mx-auto max-w-3xl space-y-5"><div><h1 className="text-xl font-semibold">Mon espace</h1><p className="text-sm text-neutral-500">Votre fiche personnelle, votre carte BTP et vos affectations.</p></div><div className="rounded-md border border-dashed p-6 text-sm text-neutral-600">Les informations personnelles sont disponibles avec un compte collaborateur individuel.</div></div></main>;
    ...
    return <main className="p-8"><div className="mx-auto max-w-3xl space-y-5">
      ...
      {!isEmailLoginDisabled()&&<section className="rounded-md border p-4"><h2 className="font-semibold">Compte et sécurité</h2><p className="mt-1 text-sm text-neutral-500">Mot de passe de connexion à l’application (différent du mot de passe de la borne stock).</p><Link href="/nouveau-mot-de-passe" className="mt-3 inline-block rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Changer mon mot de passe</Link></section>}
  ...
  return <main className="p-4 sm:p-8"><div className="mx-auto max-w-4xl space-y-6">
    ...
    {!isEmailLoginDisabled()&&<section className="rounded-md border p-4"><h2 className="font-semibold">Compte et sécurité</h2><p className="mt-1 text-sm text-neutral-500">Mot de passe de connexion à l’application (différent du mot de passe de la borne stock ci-dessous).</p><Link href="/nouveau-mot-de-passe" className="mt-3 inline-block rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Changer mon mot de passe</Link></section>}
