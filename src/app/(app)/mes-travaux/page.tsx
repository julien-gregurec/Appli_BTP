...
export default async function MesTravauxPage() {
  ...
  return <main className="ecran-mobile p-3 sm:p-8"><div className="mx-auto max-w-5xl space-y-6">
    ...
    {error && <p className="rounded bg-red-50 p-3 text-sm text-red-700">{messageErreurUtilisateur("MesTravauxPage", error, "Impossible de charger vos travaux pour le moment.")}</p>}
