  ...
  return (
    <main className="p-8">
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="flex items-start justify-between"><div><h1 className="text-xl font-semibold">Paramètres de l’entreprise</h1><p className="text-sm text-neutral-500">Ces informations apparaissent notamment sur les devis et factures.</p></div><div className="flex flex-wrap justify-end gap-2"><Link href="/parametres/securite" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Sécurité du compte</Link>{peutGererAcces&&<Link href="/parametres/import" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Importer des données</Link>}{peutGererAcces&&<Link href="/parametres/acces" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Accès et rôles</Link>}<Link href="/parametres/relances" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Relances</Link>{devisV2&&<Link href="/parametres/emails" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Modèles d’e-mail</Link>}<Link href="/parametres/notifications" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Notifications</Link><Link href="/parametres/donnees" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Mes données</Link><Link href="/parametres/version" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Version</Link></div></div>
