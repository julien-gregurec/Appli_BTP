...
import { CouleurDocumentChamp } from "@/components/parametres/CouleurDocumentChamp";
  ...
  return (
    <main className="p-8">
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="flex items-start justify-between"><div><h1 className="text-xl font-semibold">Paramètres de l’entreprise</h1><p className="text-sm text-neutral-500">Ces informations apparaissent notamment sur les devis et factures.</p></div><div className="flex flex-wrap justify-end gap-2"><Link href="/parametres/securite" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Sécurité du compte</Link>{peutGererAcces&&<Link href="/parametres/import" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Importer des données</Link>}{peutGererAcces&&<Link href="/parametres/acces" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Accès et rôles</Link>}<Link href="/parametres/relances" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Relances</Link>{devisV2&&<><Link href="/parametres/devis" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Devis</Link><Link href="/parametres/numerotation" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Numérotation</Link><Link href="/parametres/emails" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Modèles d’e-mail</Link></>}<Link href="/parametres/notifications" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Notifications</Link><Link href="/parametres/donnees" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Mes données</Link><Link href="/parametres/version" className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-neutral-50">Version</Link></div></div>
        ...
        <form action={modifierEntrepriseAction} className="space-y-6">
          ...
          <section className="space-y-4 rounded-md border border-neutral-200 p-4 dark:border-neutral-800">
            ...
            {devisV2 && (
              <>
                <div className="flex flex-wrap gap-4 rounded-md bg-neutral-50 p-3 text-sm dark:bg-neutral-900"><label className="flex items-center gap-2"><input name="afficher_references_documents" type="checkbox" defaultChecked={entreprise?.afficher_references_documents === true} />Imprimer la référence interne des lignes (devis et factures)</label></div>
                <div><label className="text-xs text-neutral-500">Conditions générales de vente</label><textarea name="cgv_texte" rows={8} maxLength={30000} defaultValue={entreprise?.cgv_texte ?? ""} className={input} placeholder="Article 1 — Objet…&#10;&#10;Article 2 — Prix…" /><p className="mt-1 text-xs text-neutral-500">Imprimées en annexe des devis (une ligne vide sépare deux paragraphes) et proposées en pièce jointe des e-mails.</p></div>
              </>
            )}
          </section>
