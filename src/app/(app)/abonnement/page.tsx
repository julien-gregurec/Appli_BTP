  ...
  return <main className="p-4 sm:p-8"><div className="mx-auto max-w-5xl space-y-6">
    ...
    <section className="rounded-xl border p-5">
      ...
      <dl className="mt-5 grid gap-3 sm:grid-cols-2">
        <div className="rounded-lg bg-neutral-50 p-3 dark:bg-neutral-900"><dt className="text-xs uppercase text-neutral-500">Offre {offre.nom}</dt><dd className="mt-1 font-semibold">{prixComptes.base === null ? "Sur devis" : `${euros(prixComptes.base)} HT/mois`}</dd><p className="text-xs text-neutral-500">{offre.devisObligatoire ? "Capacité définie au contrat" : `${offre.comptesInclus} compte(s) inclus`}</p></div>
