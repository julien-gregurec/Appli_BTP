...
export default async function RentabilitePage() {
  ...
  const lignes = (chantiers ?? []).map((chantier) => {
    ...
    return { ...chantier, clientNom, budgetHt, factureHt, heures, coutMainOeuvre, coutAchats, coutSousTraitance, coutIndemnitesPaie, marge, taux };
  });
