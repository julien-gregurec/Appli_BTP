...
def chapitres():
    return [
        introduction(),
        chapitre(modules.DEMARRAGE),
        chapitre(modules.TABLEAU_BORD),
        chapitre(modules.MESSAGERIE),
        chapitre(modules.CLIENTS),
        chapitre(modules.PRESTATIONS),
        chapitre(modules.CHANTIERS),
        chapitre(modules.MES_TRAVAUX),
        chapitre_devis(),
        chapitre(modules.FACTURES),
        chapitre(modules.FACTURATION_AVANCEE),
        chapitre(modules.CRM),
        chapitre(modules.APPELS_OFFRES),
        chapitre(modules.OUVRAGES),
        chapitre(modules.INTERVENTIONS),
        chapitre(modules.SOUS_TRAITANTS),
        ...
        chapitre(modules.GRANDS_DEPLACEMENTS),
        chapitre(modules.PAIE),
        chapitre(modules.STOCK),
        chapitre(modules.BORNE),
        chapitre(modules.OUTILLAGE),
        chapitre(modules.FLOTTE),
        chapitre(modules.COMMANDES),
        chapitre(modules.FOURNISSEURS),
        chapitre(modules.CONNECTEURS),
        chapitre(modules.DEPENSES),
        chapitre(modules.CHARGES),
        chapitre(modules.RENTABILITE),
        chapitre(modules.TRESORERIE),
        chapitre(modules.PAIEMENTS_BANCAIRES),
        chapitre(modules.EXPORTS),
        chapitre(modules.ABONNEMENT),
        chapitre(modules.IA_NOTIFICATIONS),
