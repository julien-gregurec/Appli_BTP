...
-- fonctions créées ou modifiées par 20260922000322 (portage, sur le train
-- claude/compassionate-euler-5j6avr, du lot qualifié séparément sous le
-- numéro 20260922000318 — renommé ici uniquement à cause d'une collision de
-- numéro avec une migration Performance/Dashboard intégrée entretemps ; voir
-- l'en-tête de la migration 322 pour le détail). La concurrence réelle
...
-- docs/qualification/ELSATIA_GP_COMMANDE_RECEPTION_STOCK_V1.md et dans la
-- nouvelle section du rapport de convergence du train.
--
