...
-- GP_V1_RC : section K (« capacité personnes R1/R2 ») retirée. Elle teste
-- `capacite_personnes_base`/`capacite_personnes_totale`, définies par la migration
-- 20260903000256_active_person_capacity_r1_v1 — hors périmètre GP V1, absente de cette RC.
-- Aucune assertion GP (essai/modules catalogue, sections A-J ci-dessus) n'en dépendait.
