-- Réparation mojibake : les fonctions ci-dessous contenaient des littéraux
-- accentués corrompus (même cause que 20260719000122 : collage dans l'éditeur
-- SQL sans UTF-8 forcé). Recréées ici verbatim, en UTF-8 propre.
...
-- Réparation des notifications déjà corrompues par ces mêmes fonctions.
