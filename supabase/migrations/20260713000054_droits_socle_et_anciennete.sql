-- Tous les collaborateurs disposent du socle terrain/personnel :
-- planning, pointage arrivée/départ en leur propre nom et notes de frais personnelles.
...
declare
 v_id uuid;
 v_permissions text[]:=coalesce(p_permissions,array[]::text[]) || array[
   'acces_planning','acces_pointage','saisir_son_pointage','saisir_ses_notes_frais'
 ];
begin
...
begin
 ...
 -- « Gérer » implique toujours « Consulter ».
