 ...
 *   plus là. `pruneSelection` le fait par dérivation, sans effet de nettoyage ;
...
export function FreeDrawingBoard({ projectId, projectName, geometry, onPersist }: FreeDrawingBoardProps) {
  ...
  const liveSelection = useMemo(
    () => pruneSelection(selection, new Set(drawingState.geometry.entities.map((entity) => entity.id))),
