...
import { ProCalculatorWorkspace } from "./ProCalculatorWorkspace";

export function CalculatorWorkspace({ tool }: { tool: ToolDefinition }) {
  return tool.access === "pro" ? <ProCalculatorWorkspace tool={tool} /> : <FreeCalculatorWorkspace tool={tool} />;
}

function FreeCalculatorWorkspace({ tool }: { tool: ToolDefinition }) {
