...
export function ToolIcon({ id, size = 28 }: { id: ToolId; size?: number }) {
  ...
  if (id === "cercle" || id === "plafond-circulaire") return <svg {...common}><circle cx="16" cy="16" r="11" /><circle cx="16" cy="16" r="1" fill="currentColor" stroke="none" /><path d="M16 16h11" /></svg>;
  ...
  if (id === "ellipse") return <svg {...common}><ellipse cx="16" cy="16" rx="12" ry="8" /><circle cx="11" cy="16" r="1" fill="currentColor" /><circle cx="21" cy="16" r="1" fill="currentColor" /></svg>;
  if (id === "couronne") return <svg {...common}><circle cx="16" cy="16" r="12" /><circle cx="16" cy="16" r="7" /></svg>;
  if (["fleur-4", "fleur-5", "fleur-6", "fleur-8", "rosace-radiale"].includes(id)) return <svg {...common}><circle cx="16" cy="10" r="6" /><circle cx="22" cy="16" r="6" /><circle cx="16" cy="22" r="6" /><circle cx="10" cy="16" r="6" /><circle cx="16" cy="16" r="3" /></svg>;
