...
export const promotions: readonly ElsatiaPromotion[] = [
  { id: "gestion-pro-quantitatifs", application: "gestion-pro", title: "Continuez dans ELSATIA Gestion Pro", description: "Transformez vos quantitatifs en suivi de chantier, devis et commandes.", cta: "Découvrir Gestion Pro", url: "https://app.elsatia.fr", placement: "tool-footer", contexts: ["quantitative", "project"], active: true, priority: 10 },
  { id: "colors-peinture", application: "colors", title: "Vous gérez aussi vos restes de peinture ?", description: "Centralisez vos nuanciers, références et stocks dans ELSATIA Colors.", cta: "Découvrir Colors", url: "https://colors.elsatia.fr", placement: "tool-footer", contexts: ["painting"], active: true, priority: 20 },
];
