...
`1d15289294434643b5085af3585440ac2d162ddc`, ledger visé **263** (rebasé 2026-09-05, lot
...
| T+30 | Déploiement app `1d15289` + login, `/abonnement`, dashboard, chantier, stock, pas de 5xx/boucle | | | ☐ PASS ☐ FAIL | |
...
☐ SHA app `1d15289` prêt à déployer ☐ Production Branch = branche canonique (**≠ `main`**)
