...
`b371641572489337671c89e0a9dfcf4d8c3a5824`, ledger visé **263** (rebasé 2026-09-05, lot
...
| T+30 | Déploiement app `b371641` + login, `/abonnement`, dashboard, chantier, stock, pas de 5xx/boucle | | | ☐ PASS ☐ FAIL | |
...
☐ SHA app `b371641` prêt à déployer ☐ Production Branch = branche canonique (**≠ `main`**)
