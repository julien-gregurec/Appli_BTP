...
**Traçabilité :**
- Preuve d'exécution BDD/E2E (Fresh 253 + pgTAP 870/870, Restore 253 + pgTAP 870/870, drift
  applicatif 0, E2E 40/40, MFA réel + fail-closed, Stripe TEST 8/8, rollback local 210→253→210)
  = commit **`a354d13233fd865b8cb6c735ca56c3dd0de00eca`**, `docs/audits/ELSATIA_PREPROD_DB_E2E_ROLLBACK_V1.md`
  (exécution CODEX, lot `ELSATIA-PREPROD-DB-E2E-ROLLBACK-V1`).
- Runbook opérateur (ce document) : source = commit **`a3aad60eea25bad2b123c9141dc86d00183a4c55`**
  (rédaction Claude, lot `ELSATIA-PRODUCTION-ROLLBACK-RUNBOOK-V1`).
- Les deux sont intégrés sur la lignée pré-production sans réécriture de l'historique des tests.
