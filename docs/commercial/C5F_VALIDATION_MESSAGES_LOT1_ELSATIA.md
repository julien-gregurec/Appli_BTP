# C5-F — Validation humaine des messages du lot 1 ELSATIA
...
| Ordre | Entreprise | Décideur ciblé | E-mail prévu | Statut e-mail | Variante | Canal recommandé | Téléphone |
|---:|---|---|---|---|---|---|---|
| 1 | SVMJ / STRASOL | Virginie Fillatre, interlocutrice publique ; direction opérationnelle à confirmer | `vfil@strasol.fr` | Confirmé | B — terrain/mobile | E-mail puis téléphone | Confirmé |
...
- **Décideur ciblé :** Virginie Fillatre, interlocutrice publique ; confirmer qu’elle est la bonne interlocutrice opérationnelle.
- **Adresse prévue :** `vfil@strasol.fr` — e-mail confirmé.
- **Variante :** B — terrain/mobile.
- **Objet :** Relier vos équipes terrain et votre bureau
- **Message :**
...
- **Décideur ciblé :** Éric Denni, gérant.
- **Adresse prévue :** `contact@carrelage-denni.fr` — e-mail confirmé.
- **Variante :** B — terrain/mobile.
- **Objet :** Relier vos équipes de chantier et votre bureau
- **Message :**
...
- **Décideur ciblé :** Serkan Kocyigit, gérant.
- **Adresse prévue :** `contact@crepi-style.fr` — e-mail confirmé.
- **Variante :** A — centralisation.
- **Objet :** Centraliser le suivi de vos différents métiers
- **Message :**

> Bonjour Monsieur Kocyigit,
>
...
- **Décideur ciblé :** Nicolas Ennesser, direction de l’entreprise familiale.
- **Adresse prévue :** `n.ennesser@peinture-ennesser.com` — e-mail confirmé.
- **Variante :** A — centralisation.
- **Objet :** Une vue commune de vos différents chantiers
- **Message :**

> Bonjour Monsieur Ennesser,
>
...
- **Décideur ciblé :** Philippe ou Daniel Gérard, co-gérants ; destinataire précis à confirmer à l’entrée en relation.
- **Adresse prévue :** `gerardetfils@gerardetfils.fr` — e-mail confirmé.
- **Variante :** A — centralisation.
- **Objet :** Regrouper le suivi de vos différents chantiers
- **Message :**
...
- **Décideur ciblé :** David Bacharyar, gérant.
- **Adresse prévue :** `info@mayart.fr` — e-mail confirmé.
- **Variante :** A — centralisation.
- **Objet :** Centraliser le suivi de vos différents lots
- **Message :**

> Bonjour Monsieur Bacharyar,
>
...
- **Décideur ciblé :** Safet Kucuk ou Sevket Alptekin, co-gérants ; interlocuteur opérationnel à confirmer.
- **Adresse prévue :** `akpro.contact@gmail.com` — e-mail confirmé.
- **Variante :** B — terrain/mobile.
- **Objet :** Relier vos équipes terrain et votre suivi de chantier
- **Message :**
...
**NE PAS ENVOYER PAR E-MAIL — aucune adresse professionnelle publique suffisamment fiable n’a été confirmée lors de la revérification du 16 août 2026. Le site officiel publie un formulaire et deux numéros, mais pas d’adresse e-mail.**

- **Décideur ciblé :** Yannick Cabrol ou Nicolas Fleck, co-gérants ; interlocuteur opérationnel à confirmer.
- **Adresse prévue :** aucune — e-mail non confirmé.
- **Variante :** B — terrain/mobile.
- **Objet préparatoire, utilisable seulement après confirmation d’une adresse :** Relier votre showroom et vos équipes de pose
- **Message préparatoire non envoyable en l’état :**
...
- **Décideur ciblé :** Yahya Eren, gérant.
- **Adresse prévue :** `contact@scecarrelage.fr` — e-mail confirmé.
- **Variante :** B — terrain/mobile.
- **Objet :** Relier le suivi des interventions et le terrain
- **Message :**
...
1. vérifier une nouvelle fois l’identité du destinataire, l’adresse et la source ;
2. contrôler l’onglet `OPPOSITIONS` ;
3. relire le fait public et la formulation de l’hypothèse ;
4. confirmer qu’un seul CTA est présent ;
5. envoyer manuellement depuis `contact@elsatia.fr` uniquement après validation ;
6. enregistrer l’action seulement après l’envoi réel ;
7. arrêter immédiatement tous les canaux en cas d’opposition.

CF PARQUET reste exclu de tout envoi e-mail tant qu’une adresse professionnelle actuelle n’est pas confirmée. MAYART reste limité à l’e-mail et à une éventuelle relance e-mail : aucun téléphone professionnel n’a été trouvé et aucun profil LinkedIn public pertinent n’a été retenu.
