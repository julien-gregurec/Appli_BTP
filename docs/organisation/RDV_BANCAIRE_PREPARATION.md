# Préparation du rendez-vous bancaire — compte dédié ELSATIA

Rendez-vous prévu : **jeudi 27 août 2026**. Document de préparation uniquement — aucune démarche bancaire n'est effectuée par ce dépôt, aucun identifiant bancaire n'est demandé ni communiqué ici.
...
- [ ] Justificatif de la formalité INPI déjà signée/payée.
- [ ] Synthèse PDF INPI.
- [ ] SIREN/SIRET de l'EI (si reçu avant le rendez-vous — sinon, la formalité déposée suffit généralement à ouvrir un compte en attente d'immatriculation, à confirmer avec la banque).
- [ ] Extrait RNE actuel, si disponible.
- [ ] Nom commercial : ELSATIA.
- [ ] Site : elsatia.fr.
- [ ] Description de l'activité SaaS.
- [ ] Preuve du domaine / capture du site, si disponible.
...
- éventuellement les dépenses SaaS et abonnements techniques.

Caractéristiques à demander précisément :
- [ ] IBAN français.
- [ ] Compte courant (pas un livret).
- [ ] Carte bancaire.
- [ ] Virements SEPA entrants/sortants.
- [ ] Prélèvements SEPA.
- [ ] Relevés PDF téléchargeables.
- [ ] Intitulé de compte type « Julien GREGUREC EI – ELSATIA ».
- [ ] Frais mensuels exacts.
- [ ] Commissions sur virements.
- [ ] Coût de la carte.
- [ ] Frais de tenue de compte.
- [ ] Conditions de clôture.

## 5. Les 5 questions à poser au conseiller

1. Le compte est-il compatible avec les virements Stripe ?
2. L'intitulé peut-il comporter « ELSATIA » en plus du nom / EI ?
3. Y a-t-il une durée d'engagement ?
4. Quel est le coût total mensuel réel, carte comprise ?
5. Relevés et opérations exportables facilement en CSV/PDF ?

## 6. Mise en garde

Ne pas souscrire sur place à une assurance, un terminal de paiement, un crédit ou un pack « pro » coûteux. Demander les tarifs, récupérer les documents, comparer avant de signer quoi que ce soit.
