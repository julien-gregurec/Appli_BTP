...
| Accès selon les postes | 🟡 Migration 43 à valider | Les modules sans droit Consulter sont absents du menu et du dashboard, leurs données ne sont pas chargées et leurs URLs/pages PDF/API redirigent. La migration 43 ajoute la défense RLS/stockage/RPC des droits Gérer et reste à tester dans Supabase. |
