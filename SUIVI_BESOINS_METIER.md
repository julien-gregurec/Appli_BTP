...
| Accès selon les postes | ✅ Fait | Chaque module sépare désormais **Consulter** et **Gérer**. La lecture seule bloque les mutations côté interface et serveur. Les postes sont repliables avec un résumé membres/consultations/gestions pour garder une vue compacte. « Gérer » active automatiquement « Consulter ». |
...
| Compte et accès propres à chaque collaborateur | 🟡 Prêt à activer | Invitation partageable depuis les rôles, lien d’inscription avec code prérempli, demande d’accès, validation par l’admin puis poste avec droits Consulter/Gérer. La séparation réelle des utilisateurs nécessite la sortie volontaire du mode prototype sans connexion. |
